...
let heightBanner = document.querySelector('.general-banner');
var x = window.matchMedia("(max-width: 700px and min-height: 500px)")
console.log(x);

// if (heightBanner) {
//     let topDistance = heightBanner.offsetHeight;
//     menuLeft.style.top = topDistance;
